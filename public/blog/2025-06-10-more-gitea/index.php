...
<section>
  ...
  <p>Since the next goal was to set up a redeployment workflow for the website, I had to find a CI/CD solution. Typically with CI/CD I work with GitHub actions and I quickly found out that Gitea has its own GitHub Actions style CI/CD solution that is built in, naturally called Gitea Actions. From then I knew what I would be using.</p>
